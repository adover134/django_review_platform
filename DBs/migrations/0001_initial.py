...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Manager',
            fields=[
                ('u_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='DBs.user')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='room', to='DBs.room')),
                ('u_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='writer', to='DBs.user')),
            ],
        ),
        migrations.CreateModel(
            name='Option',
            fields=[
                ...
                ('room_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='options', to='DBs.room')),
            ],
        ),
        migrations.CreateModel(
            name='Icon',
            fields=[
                ...
                ('rev_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='icons', to='DBs.review')),
            ],
        ),
    ]
